...
from cnm.scene_lvl.crnn_orig.dataset_loader import VicCycLegacyDataset
...
def main(csv_data_path, rgb_frame_data_path, opt_frame_data_path, fused_frame_data_path,
         h_res_size=224, w_res_size=224, forward_frame_len=20, backward_frame_len=25, input_type='rgb_only',
    ...
    :param csv_data_path:
    :param rgb_frame_data_path:
    :param input_type:
        rbg_only: single stream of rgb
        rbg_and_opt: two streams of rgb and opt
        fused: fused rgb and optical flow
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_data_path', type=str, default=repo_dir_path,
